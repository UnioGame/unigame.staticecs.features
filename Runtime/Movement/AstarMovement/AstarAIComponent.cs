namespace UniGame.StaticEcs.Features
{
    ...
    public struct AstarAIComponent : IComponent
    {
        ...
        /// <summary>The A* request component whose graph mask is controlled by ECS.</summary>
        public Seeker Seeker;

        /// <summary>The ECS graph entity that must be initialized before path requests are issued.</summary>
