...
namespace unigame.staticecs.features {
    ...
    public sealed class EffectIdRegistry : IResource {
        ...
        public EffectId Register<TEffect>() where TEffect : struct, IEffectType {
        ...
        public bool TryGet<TEffect>(out EffectId id) where TEffect : struct, IEffectType {
            return _byType.TryGetValue(typeof(TEffect), out id);
        }

        public EffectId Get<TEffect>() where TEffect : struct, IEffectType {
