...
namespace UniGame.StaticEcs.Features.Editor.AbilityGraph {
    internal static class AbilityGraphDefaultContextCommands {
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Sequence/Add Child...", Order = -10, NodeType = typeof(SequenceStepConfig))]
        private static void AddSequenceChild(AbilityGraphContextCommandContext context) {
            ...
            AbilityGraphNodePickerWindow.Open(entry => {
                if (AbilityGraphAssetEditing.AppendChild(context.Asset, sequence, "_children", entry)) {
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Parallel/Add Branch...", Order = -10, NodeType = typeof(ParallelStepConfig))]
        private static void AddParallelBranch(AbilityGraphContextCommandContext context) {
            ...
            AbilityGraphNodePickerWindow.Open(entry => {
                if (AbilityGraphAssetEditing.AppendChild(context.Asset, parallel, "_children", entry)) {
                    AbilityGraphEditorWindow.OpenTab(context.Asset);
                    Selection.activeObject = context.Asset;
                }
            });
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Conditional/Set True Branch...", Order = -10, NodeType = typeof(ConditionalStepConfig))]
        private static void SetConditionalTrueBranch(AbilityGraphContextCommandContext context) {
            if (context.Asset == null || context.NodeConfig is not ConditionalStepConfig conditional) {
                return;
            }
            ...
            AbilityGraphNodePickerWindow.Open(entry => {
                ...
                if (AbilityGraphAssetEditing.AssignChild(context.Asset, conditional, "_ifTrue", entry)) {
                    AbilityGraphEditorWindow.OpenTab(context.Asset);
                    Selection.activeObject = context.Asset;
                }
            });
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Conditional/Set False Branch...", Order = 0, NodeType = typeof(ConditionalStepConfig))]
        private static void SetConditionalFalseBranch(AbilityGraphContextCommandContext context) {
            ...
            AbilityGraphNodePickerWindow.Open(entry => {
                ...
                if (AbilityGraphAssetEditing.AssignChild(context.Asset, conditional, "_ifFalse", entry)) {
                    AbilityGraphEditorWindow.OpenTab(context.Asset);
                    Selection.activeObject = context.Asset;
                }
            });
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Repeat/Set Body...", Order = -10, NodeType = typeof(RepeatStepConfig))]
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Background, "Graph/Open Project Browser", Order = 0)]
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Background, "Graph/Open Runtime Browser", Order = 10)]
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Background, "Graph/Clear Selection", Order = 20)]
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Node/Clear Selection", Order = 20)]
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Edge, "Edge/Clear Selection", Order = 20)]
        private static void ClearSelection(AbilityGraphContextCommandContext context) {
            context.CanvasView?.ClearSelection();
        }

        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Node/Copy NodeGuid", Order = 0)]
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Node/Copy Node Type", Order = 10)]
        private static void CopyNodeType(AbilityGraphContextCommandContext context) {
            EditorGUIUtility.systemCopyBuffer = context.NodeConfig?.GetType().FullName ?? string.Empty;
        }
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Node/Ping Ability Asset", Order = 30)]
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Edge, "Edge/Ping Ability Asset", Order = 30)]
        ...
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Composite/Copy Child Count", Order = 40, NodeType = typeof(SequenceStepConfig))]
        [AbilityGraphContextCommand(AbilityGraphContextTarget.Node, "Composite/Copy Child Count", Order = 40, NodeType = typeof(ParallelStepConfig))]
        ...
        private static void CreateRootNode(AbilityAsset asset, AbilityGraphNodeTypeRegistry.Entry entry) {
