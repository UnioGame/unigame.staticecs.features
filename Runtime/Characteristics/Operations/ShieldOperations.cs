...
namespace UniGame.StaticEcs.Features {
    public static class ShieldOperations {
        public static bool Add<TWorld>(EntityGID target, float amount)
            ...
            return CharacteristicOperations.AddValue<TWorld, ShieldCharacteristic>(ref shield, target, amount);
        }
        ...
        public static float Consume<TWorld>(EntityGID target, float amount)
            ...
            CharacteristicOperations.AddValue<TWorld, ShieldCharacteristic>(ref shield, target, -consumed);
            return consumed;
        }
        ...
        public static bool Break<TWorld>(EntityGID target)
            ...
            ref var shield = ref entity.Mut<CharacteristicComponent<ShieldCharacteristic>>();
            return CharacteristicOperations.SetValue<TWorld, ShieldCharacteristic>(ref shield, target, 0f);
        }
    }
}
