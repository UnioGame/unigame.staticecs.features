...
namespace UniGame.StaticEcs.Features
{
    ...
    [CreateAssetMenu(menuName = "Static ECS/Features/Astar Movement", fileName = nameof(AstarMovementFeatureAsset))]
    public sealed class AstarMovementFeatureAsset : StaticEcsFeatureAsset
    {
        ...
        public override IStaticEcsFeature<Main> CreateFeature(IContext context) =>
            new AstarMovementFeature(registerGraphSystem, registerMovementSystem, graphOrder, movementOrder);
    }
}
