...
namespace UniGame.StaticEcs.Features {
    ...
    /// <see cref="EffectSourceTracker"/> consumes the registry on source destroy and
    ...
    public sealed class EffectRegistry : IResource {
        ...
        private readonly EffectUnconditionalRemove[] _removeSlots = new EffectUnconditionalRemove[MaxSlots];
        private ulong _registeredMask;

        public ulong RegisteredMask => _registeredMask;

        public void Register(EffectFlag flag, EffectSourceCleanup cleanup, EffectUnconditionalRemove unconditional) {
            if (cleanup == null) {
